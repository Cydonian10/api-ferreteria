...
import { createSaleSchema, type CreateSaleDto } from './dto/create-sale.dto.js';
import { CreateSaleCommand } from './commands/create-sale.command.js';
import { FindAllSalesQuery } from './queries/find-all-sales.query.js';
